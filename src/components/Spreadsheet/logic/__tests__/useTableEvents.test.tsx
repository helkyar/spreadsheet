...
describe('useTableEvents hook tested through ui', () => {
  ...
  it('should select column on column header click', async () => {
  ...
  it('should select above cell on arrow-up key press if cell is focused', () => {
    // const { x: prevX = -1, y: prevY = -1 } = activeElement().dataset
  ...
  it('should select right cell on arrow-right key press if cell is focused', () => {
    // const { x: prevX = -1, y: prevY = -1 } = activeElement().dataset
  ...
  it('should select left cell on arrow-left key press if cell is focused', () => {
    // const { x: prevX = -1, y: prevY = -1 } = activeElement().dataset
